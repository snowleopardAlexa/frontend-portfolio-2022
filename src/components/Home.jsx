...
const Home = () => {
  return (
  <div name="home" className="w-full sm:h-screen sm:text-center bg-[#333399]">
    {/* container */}
    <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
      <p className="mt-40 text-white py-4 font-Roboto">Hi, call me Alexa!</p>
      ...
      <div>
          <button className="mb-20 text-white sm:mx-auto group border-2 px-6 py-3 my-2 flex items-center hover:bg-white-600 hover:border-pink-600 hover:text-[#ff00cc]">
